...
Craft_Name   = 'SUTD_Ideal_(Hybrid_Wing_Climb_Gain_II)_'; % Craft Name
Resolution   = 30;                               % Number of blade elements
m            = 0.280;                            % Mass of Craft (kg)
R            = 0.4;                             % Wing Radius (m)
...
x_motor      = [0.37 ; 0 ; 0];                   % Distance Between Motor and Centre of Mass (m)        
...
Cl_grad      = 6.0849;                           % We assume wing operates along linear Cl/Alpha region
Cl_upper     =  0.20944;                         % Upper angle limit of Cl_grad assumption
Cl_lower     = -0.20944;                         % Lower angle limit of Cl_grad assumption
Cl_optimal   =  0.13526;                         % Optimal point of Cl_grad assumption

r              = linspace((1./Resolution),1,Resolution);
prop_data      = xlsread(prop_file,1);
airfoil_data   = xlsread(airfoil_file,'Main','A3:D335');
folder         = '/Users/lowjunen/GitHub/Monocopter/Base VIII/Output/';
...
t_total      = 20;                                   % total ODE45 time analyzed
